...
class LIRIEGLFS_EXPORT EGLDeviceIntegration
{
public:
...
class LIRIEGLFS_EXPORT EGLDeviceIntegrationPlugin : public QObject
{
    Q_OBJECT
public:
...
LIRIEGLFS_EXPORT EGLDeviceIntegration *egl_device_integration();
