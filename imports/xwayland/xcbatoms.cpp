...
Atoms::Atoms()
    ...
    , wm_change_state(QByteArrayLiteral("WM_CHANGE_STATE"), false)
    ...
    , net_active_window(QByteArrayLiteral("_NET_ACTIVE_WINDOW"), false)
    ...
    , window(QByteArrayLiteral("WINDOW"), false)
